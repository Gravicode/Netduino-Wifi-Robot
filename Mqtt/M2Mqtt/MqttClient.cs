    ...
    public class MqttClient
    {
        ...
        private void Send(byte[] msgBytes)
        {
            try
            {
                ...
                this.lastCommTime = Lingkungan.TickCount;
#endif
            }
            catch (Exception e)
            {
        ...
        private void KeepAliveThread()
        {
            ...
            while (this.isRunning)
            {
                ...
                if (this.isRunning)
                {
                    delta = Lingkungan.TickCount - this.lastCommTime;
                            ...
                            while (count > 0)
                            {
                                ...
                                switch (msgContext.State)
                                {
                                    ...
                                    case MqttMsgState.SendUnsubscribe:
                                        ...
                                        if (msgContext.Flow == MqttMsgFlow.ToPublish)
                                        {
                                            msgContext.Timestamp = Lingkungan.TickCount;
                                            msgContext.Attempt++;
                                    ...
                                    case MqttMsgState.WaitForUnsuback:
                                        ...
                                        if (msgContext.Flow == MqttMsgFlow.ToPublish)
                                        {
                                            ...
                                            if (!acknowledge)
                                            {
                                                delta = Lingkungan.TickCount - msgContext.Timestamp;
